...
{
	CDialogEx::DoDataExchange(pDX);
	//  DDX_Text(pDX, IDC_EDIT1, m_jam);
	//  DDX_Text(pDX, IDC_EDIT2, m_menit);
	//  DDX_Control(pDX, IDC_EDIT3, m_hasil);
	//  DDX_Text(pDX, IDC_EDIT3, m_hasil);
	//  DDX_Text(pDX, IDC_EDIT1, m_jam);
	//  DDX_Text(pDX, IDC_EDIT2, m_menit);
	//  DDX_Text(pDX, IDC_EDIT1, m_detik);
	DDX_Text(pDX, IDC_EDIT1, m_detik);
}
...
BEGIN_MESSAGE_MAP(CMFCApplication7Dlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_EN_CHANGE(IDC_EDIT2, &CMFCApplication7Dlg::OnEnChangeEdit2)
	ON_BN_CLICKED(IDC_BUTTON1, &CMFCApplication7Dlg::OnBnClickedButton1)
	ON_EN_CHANGE(IDC_EDIT1, &CMFCApplication7Dlg::OnEnChangeEdit1)
END_MESSAGE_MAP()
...
void CMFCApplication7Dlg::OnEnChangeEdit2()
{
